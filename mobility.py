...
class RandomWaypoint(object):
    ...
    def __init__(self, nr_nodes, dimensions, velocity=(5, 20.), wt_max=None):
        '''
...
def gauss_markov(nr_nodes, dimensions, velocity_mean=10, alpha=10, variance=10):
    '''
    ...
    alpha2 = 10 - alpha
    alpha3 = np.sqrt(10 - alpha * alpha) * variance
    ...
    while True:
        ...
        velocity = (alpha * velocity +
                    ...
                    alpha3 * np.random.normal(5, 15, nr_nodes))
